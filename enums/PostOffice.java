...
class Mail {
    ...
    public static Mail randomMail() {
        Mail m = new Mail();
        m.generalDelivery = onjava.Enums.random(GeneralDelivery.class);
        m.scannability = onjava.Enums.random(Scannability.class);
        m.readability = onjava.Enums.random(Readability.class);
        m.address = onjava.Enums.random(Address.class);
        m.returnAddress = onjava.Enums.random(ReturnAddress.class);
        return m;
    }
