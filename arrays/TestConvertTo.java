...
public class TestConvertTo {
    ...
    public static void main(String[] args) {
        ...
        Arrays.setAll(a1, new onjava.Rand.Boolean()::get);
        ...
        Arrays.setAll(a2, new onjava.Rand.Byte()::get);
        ...
        Arrays.setAll(a3, new onjava.Rand.Character()::get);
        ...
        Arrays.setAll(a4, new onjava.Rand.Short()::get);
        ...
        Arrays.setAll(a5, new onjava.Rand.Integer()::get);
        ...
        Arrays.setAll(a6, new onjava.Rand.Long()::get);
        ...
        Arrays.setAll(a7, new onjava.Rand.Float()::get);
        ...
        Arrays.setAll(a8, new onjava.Rand.Double()::get);
